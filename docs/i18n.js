...
const translations = {
    en: {
        ...
        chess_insight: "Gemini 3.1 crushes Claude 5-0",
        poker_name: "Poker",
        ...
        avalon_insight: "Shell strategies swing 0-100%",
        ...
        finding2_label: "Shell Effect",
        finding2_text: 'Strategy documents change win rates <strong>0% to 100%</strong>. Counter structures exist — metagame is real.',
    ...
    ko: {
        ...
        finding2_label: "Shell 효과",
        finding2_text: '전략 문서 하나로 승률이 <strong>0%에서 100%</strong>까지 변동. 상성 구조가 존재 — 메타게임이 성립.',
